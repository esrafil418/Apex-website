								...
								<div className="introduction">
									...
									<div className="introduction__topic">
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0" classNameName="accordion">
												<Accordion.Header>معرفی دوره</Accordion.Header>
												<Accordion.Body classNameName="introduction__accordion-body">
											...
											<Accordion.Item eventKey="1" classNameName="accordion">
												<Accordion.Header>
